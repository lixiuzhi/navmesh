...
public struct IntRect1
{
    ...
    public IntRect1(int left, int top, int width, int height)
    {
        this.m_XMin = left;
        this.m_YMin = top;
        this.m_Width = width;
    ...
    public static IntRect1 MinMaxRect(int left, int top, int right, int bottom)
    {
        return new IntRect1(left, top, right - left, bottom - top);
    }
    ...
    public static bool operator !=(IntRect1 lhs, IntRect1 rhs)
    {
